...
This optimization was applied to both desktop.html and mobile.html. Future Bolt countdown PRs for these same elements are auto-rejected — the work is done. Do not re-propose countdown timer changes.
